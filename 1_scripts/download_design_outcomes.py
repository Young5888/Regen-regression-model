"""
Download the design_outcomes table from BigQuery and save it to raw_data folder.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download BigQuery design_outcomes table to raw_data")
