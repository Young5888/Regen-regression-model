"""
Download the facilities table from BigQuery and save it to raw_data folder.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download BigQuery facilities table to raw_data")
