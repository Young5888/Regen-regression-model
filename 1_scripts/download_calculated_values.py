"""
Download the calculated_values table from BigQuery and save it to raw_data folder.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download BigQuery calculated_values table to raw_data")
